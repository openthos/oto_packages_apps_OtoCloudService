...
//    private List<SeafDirent> mSelectedItemsValues = new ArrayList<>();
...
//    }
    ...
    /**
     * To refresh downloading status of
...
//     * ignore directories and repos.</br>V
//     *
//     * @param dirent
//     * @param viewHolder
//     * @param position
...
//        List<SeafGroup> groups = new ArrayList<>();
//        List<SeafCachedFile> cachedFiles = new ArrayList<>();
//        List<SeafDirent> folders = new ArrayList<>();
//        List<SeafDirent> files = new ArrayList<>();
