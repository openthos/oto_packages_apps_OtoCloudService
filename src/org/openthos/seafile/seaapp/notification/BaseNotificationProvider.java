...
import org.openthos.seafile.seaapp.transfer.TransferManager;
...
public abstract class BaseNotificationProvider {
    ...
    protected NotificationManager mNotifMgr = (NotificationManager) SeafileActivity.mActivity.
            getSystemService(SeafileActivity.mActivity.NOTIFICATION_SERVICE);
